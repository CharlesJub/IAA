...
df_auto <-  df_auto %>% mutate(Car_Make = case_when(Car_Make == "toyouta" ~ 'toyota',
                                        Car_Make == "chevroelt" ~ 'chevrolet',
                                        Car_Make == "vw" ~ "volkswagen",
                                        Car_Make == "chevy" ~ "chevrolet",
                                        Car_Make == "maxda" ~ "mazda",
                                        Car_Make == "vokswagen" ~ "volkswagen",
                                        Car_Make == 'mercedes-benz' ~ "mercedes",
                                        .default = Car_Make)
                   )
unique(df_auto$Car_Make) %>% sort()
